...
subtype YYSTYPE is ada05_Model.Parseable_Ptr;
    ...
    type Token is
        (End_Of_Input, Error, Char_Literal_Token, String_Literal_Token,
         ...
         Task_Token, Tagged_Token, Synchronized_Token,
         Subtype_Token, Separate_Token, Select_Token,
         Reverse_Token, Return_Token, Requeue_Token,
         Renames_Token, Rem_Token, Record_Token,
         Range_Token, Raise_Token, Protected_Token,
         Procedure_Token, Private_Token, Pragma_Token,
         Package_Token, Out_Token, Overriding_Token,
         Others_Token, Or_Token, Of_Token,
         Null_Token, Not_Token, New_Token,
         Mod_Token, Loop_Token, Limited_Token,
         Is_Token, Interface_Token, In_Token,
