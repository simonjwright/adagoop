...
package small_Visitor_Interface is
   type Visit_small_Interface is interface;

   procedure Visit_Parseable_Token(
      I : access Visit_small_Interface;
      T : access small_Model.Parseable_Token'Class) is null;
